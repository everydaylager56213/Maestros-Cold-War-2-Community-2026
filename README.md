...
# 🎮 Maestro's Cold War 2 — Community Edition

**Geopolitical grand strategy in a self-contained offline build**
...
Maestro's Cold War 2 is a grand strategy simulation that puts players in charge of a superpower during the height of the Cold War, balancing diplomacy, espionage, economy, and proxy conflicts. This Community Edition is a standalone, self-contained package that runs fully offline with no storefront required. The build includes all content and is ready to play immediately.

Strategy and simulation fans who want a complete, self-contained offline version of Maestro's Cold War 2.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3204120/9de88b3b75c8b0e5a48af6ac21a20540b10e7993/ss_9de88b3b75c8b0e5a48af6ac21a20540b10e7993.1920x1080.jpg?t=1788167108" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3204120/4beeed8defcc0bac33d496a096a59dd0f7c9b0f7/ss_4beeed8defcc0bac33d496a096a59dd0f7c9b0f7.1920x1080.jpg?t=1788167108" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3204120/66dc575561c31075f64a137a4466df92431791a9/ss_66dc575561c31075f64a137a4466df92431791a9.1920x1080.jpg?t=1788167108" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🌍 **Global Sandbox** — Take control of any nation on a fully simulated world map.
- 🕵️ **Espionage Operations** — Run spy networks, intercept intelligence, and sabotage rivals.
- 🤝 **Diplomacy System** — Negotiate treaties, forge alliances, and manage international tension.
- 📈 **Economic Management** — Balance national budgets, trade routes, and industrial output.
- ⚔️ **Proxy Conflicts** — Influence regional wars without triggering direct confrontation.
- 🕰️ **Historical Scenarios** — Replay key Cold War crises from 1946 onward or rewrite history.
- 💾 **Offline Play** — Fully playable offline — no storefront or additional software required.
- 🔌 **LAN Multiplayer** — LAN or direct connection supported for matches with other players.

- **Compression:** Lossless
- **Install Time:** ~2 minutes on SSD, ~5 minutes on HDD
- **Recoding:** none
- **Selective Download:** Base game and optional scenario packs can be downloaded separately

---

## 📦 DLCs Included

- Iron Curtain Scenario Pack
- Space Race Content Pack
...
| **Processor** | Intel Core i3-2100 / AMD Athlon II X3 450 | Intel Core i5-8400 / AMD Ryzen 5 2600 |
| **RAM** | 4 GB | 8 GB |
| **Graphics** | NVIDIA GeForce 8800 GT / Intel HD Graphics 4000 | NVIDIA GeForce GTX 750 Ti / AMD Radeon R7 360 |
| **Storage** | 4 GB available space | 4 GB available space on SSD |
| **Additional** | DirectX 11 compatible sound card | DirectX 11, keyboard and mouse |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Maestro'sColdWar2\Saved`
